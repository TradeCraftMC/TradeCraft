<template>
    <div>
        <TransitionRoot as="template" :show="sidebarOpen">
            ...
            >
                ...
                <div class="fixed inset-0 flex">
                    ...
                    >
                        <DialogPanel class="relative flex mr-32 flex-1">
                            <TransitionChild
                                as="template"
                            ...
                            >
                                <div
                                    class="flex flex-row h-24 shrink-0 items-center justify-center"
                                >
                                    <img
                                        class="h-8 w-auto"
                                    ...
                                    />
                                    <span
                                        class="ml-3 bg-cyan-200 px-1 py-0.5 rounded-md text-xs font-bold font-display text-zinc-900"
                                        >Admin</span
                                    >
                                </div>
                                <nav>
        ...
        >
            <div
                class="flex flex-col h-24 shrink-0 items-center justify-center"
            >
                <img
                    class="h-8 w-auto"
                    :src="`/assets/favicon.png`"
                ...
                />
                <span
                    class="mt-3 bg-cyan-200 px-1 py-0.5 rounded-md text-xs font-bold font-display text-zinc-900"
                    >Admin</span
                >
            </div>
            <nav class="mt-8">
                <ul
                    role="list"
                    class="flex flex-col items-stretch space-y-4 mx-2"
                >
                    <li v-for="(item, itemIdx) in navigation" :key="item.href">
                        <NuxtLink
                            :href="item.href"
                            :class="[
...
const currentNavigationIndex = useCurrentNavigationIndex(ref(navigation));
